...
static asmlinkage ssize_t(*old_sys_read) (unsigned int fd, char __user * buf, size_t count);
static asmlinkage ssize_t my_sys_read(unsigned int fd, char __user * buf, size_t count)
{
